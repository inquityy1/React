 ...
 * (to simplify child classes so they don't need constructor of their own).
 *
 * It contains useful function for summing, counting values, and counting
...
class LargeStraight extends Rule {
  evalRoll = (dice) => {
    ...
    // large straight must be 5 differend dice & only one can be a 1 or a 6
...
const smallStraight = new SmallStraight({
  score: 30,
  description: "30 points for a small",
});
const largeStraight = new LargeStraight({
  score: 40,
  description: "40 points for a large",
});
